        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="/admin/banner/add-home-bottom-banner" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="">Upload Image</label>
                        <input type="text" name="banner_url" class="form-control" value="http://" id="">
                        <small id="helpId" class="text-warning">Don't delete http:// (example: http://www.yourlink.com)</small>
                    </div>

                    <input type="hidden" name="banner_type" value="bottom_home_banner2">
